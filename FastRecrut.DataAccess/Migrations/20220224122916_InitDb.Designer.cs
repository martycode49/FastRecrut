...
namespace FastRecrut.DataAccess.Migrations
{
    ...
    [Migration("20220224122916_InitDb")]
            ...
            modelBuilder.Entity("FastRecrut.Entities.Concrete.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AgentId = 1,
                            Civility = "M.",
                            CreatedAt = new DateTime(2022, 2, 24, 13, 29, 15, 71, DateTimeKind.Local).AddTicks(8343),
                            Email = "m.leblanc@exemple.com",
                            Firstname = "Matt",
                            IsActive = true,
                            IsAdmin = true,
                            LastLogin = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(7574),
                            Lastname = "LeBlanc",
                            Phone = "0102030405",
                            Status = "Agent"
                        },
                        new
                        {
                            AgentId = 2,
                            Civility = "M.",
                            CreatedAt = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9440),
                            Email = "m.perry@exemple.com",
                            Firstname = "Matthew",
                            IsActive = true,
                            IsAdmin = true,
                            LastLogin = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9472),
                            Lastname = "Perry",
                            Phone = "0102030405",
                            Status = "Agent"
                        },
                        new
                        {
                            AgentId = 3,
                            Civility = "M.",
                            CreatedAt = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9483),
                            Email = "c.cox@exemple.com",
                            Firstname = "Courteney",
                            IsActive = true,
                            IsAdmin = false,
                            LastLogin = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9489),
                            Lastname = "Cox",
                            Phone = "0102030405",
                            Status = "Agent"
                        },
                        new
                        {
                            AgentId = 4,
                            Civility = "M.",
                            CreatedAt = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9497),
                            Email = "np.harris@exemple.com",
                            Firstname = "Neil Patrick",
                            IsActive = true,
                            IsAdmin = false,
                            LastLogin = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9501),
                            Lastname = "Harris",
                            Phone = "0102030405",
                            Status = "Agent"
                        },
                        new
                        {
                            AgentId = 5,
                            Civility = "M.",
                            CreatedAt = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9509),
                            Email = "w.miller@exemple.com",
                            Firstname = "Wentworth",
                            IsActive = true,
                            IsAdmin = false,
                            LastLogin = new DateTime(2022, 2, 24, 13, 29, 15, 77, DateTimeKind.Local).AddTicks(9514),
                            Lastname = "Miller",
                            Phone = "0102030405",
                            Status = "Agent"
                        });
            ...
            modelBuilder.Entity("FastRecrut.Entities.Concrete.ParticipantData", b =>
                {
                    ...
                    b.Property<int?>("AgentParticipantsAgtPartId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgentParticipantsAgtPartId");
            ...
            modelBuilder.Entity("FastRecrut.Entities.Concrete.ParticipantData", b =>
                {
                    ...
                    b.HasOne("FastRecrut.Entities.Concrete.AgentParticipant", "AgentParticipants")
                        .WithMany("ParticipantDatas")
                        .HasForeignKey("AgentParticipantsAgtPartId");
